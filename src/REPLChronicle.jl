...
using StyledStrings:
    @styled_str as @S_str, Face, addface!, face!, annotations, AnnotatedIOBuffer, AnnotatedString, AnnotatedChar
...
function __init__()
    ...
    # Hook into the REPL
    Base.active_repl.interface.modes[1].keymap_dict['\x12'] = (s::REPL.LineEdit.MIState, _...) -> repl_history_hook!(s)
end
